(function () {
    ...
    if (/Android|BlackBerry|iPhone|iPad|iPod|webOS/i.test(navigator.userAgent) === false && checkWidth() === true) {

        //I dodaj klasę 'when-not-mobile
        var toPosition = document.getElementById('add-here');
        
        console.log(toPosition);
        toPosition.classList.add('add-when-not-mobile');
